...
Specify α level (default 0.05) and test direction upfront.
...
|---|---|---|
| *t*-test | Cohen's *d* | (M₁ − M₂) / SD_pooled |
| ANOVA | η² or ω² | SS_effect / SS_total |
| Chi-square | Cramér's *V* | √(χ²/(*n* × min(r−1, c−1))) |
| Correlation | *r* | Pearson or Spearman |
| Regression | *R*² / β | From model summary |
...
F(2, 117) = 8.34, p < .001, η² = .13, 95% CI [.04, .23]
